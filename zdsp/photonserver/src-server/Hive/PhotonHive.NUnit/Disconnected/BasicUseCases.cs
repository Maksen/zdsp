...
namespace Photon.Hive.Tests.Disconnected
{
    ...
    public class BasicUseCases
    {
        ...
        public void BiggerThenMaxEmptyRoomLiveTimeTest()
        {
            ...
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne);
            ...
            try
            {
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerOne, request, new SendParameters());
                Assert.IsTrue(peerOne.WaitForNextResponse(WaitTimeout));

                Assert.AreEqual(MaxRoomLiveTime, room.Room.EmptyRoomLiveTime);

                room.Dispose();
                PeerHelper.SimulateDisconnect(HivePeerOne);
        ...
        public void JoinGameOldRejoin()
        {
            ...
            var HivePeerOne = new TestHivePeer(peerTwo.Protocol, peerOne, "myuser1");
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo, "myuser2");
            RoomReference room = null;
            TestGame game = null;
            ...
            try
            {
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerTwo, request, new SendParameters());
                ...
                room = TestGameCache.Instance.GetRoomReference("testGame", HivePeerTwo);                
                game = (TestGame)room.Room;

                PeerHelper.SimulateDisconnect(HivePeerTwo);                
                game.WaitRemovePeerFromGame();

                HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo, "myuser2");
        ...
        public void CreateOrJoinGameWithExpectedPlugin()
        {
            ...
            var peerTwo = new DummyPeer();
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne);
            var HivePeerTwo = new TestHivePeer(peerOne.Protocol, peerTwo);
            RoomReference room = null;
            ...
            try
            {
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerOne, createGameRequest, new SendParameters());
                Assert.IsTrue(peerOne.WaitForNextResponse(WaitTimeout));
                ...
                HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne);
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerOne, joinGameRequest, new SendParameters());
                Assert.IsTrue(peerOne.WaitForNextResponse(WaitTimeout));
                ...
                room = TestGameCache.Instance.GetRoomReference("testGame", HivePeerOne);
                ...
                joinGameRequest[(byte)ParameterKey.Plugins] = new string[] { "DefaultX" };
                PeerHelper.InvokeOnOperationRequest(HivePeerTwo, joinGameRequest, new SendParameters());
                Assert.IsTrue(peerTwo.WaitForNextResponse(WaitTimeout));
        ...
        public void CreateGame()
        {
            ...
            var peerTwo = new DummyPeer();
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne);
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo);
            ...
            try
            {
                ...
                PeerHelper.SimulateDisconnect(HivePeerTwo);
                HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo);
        ...
        public void ReinitGameTest()
        {
            ...
            try
            {
                ...
                var room = TestGameCache.Instance.GetRoomReference(GameName, HivePeerOne);
                var game = (TestGame)room.Room;
        ...
        public void GetSetNewGameState()
        {
            var peerOne = new DummyPeer();
            var peerTwo = new DummyPeer();
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne, "User1");
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo, "User2");
            ...
            try
            {
                ...
                HivePeerTwo.SetUserId(HivePeerOne.UserId);
                PeerHelper.InvokeOnOperationRequest(HivePeerTwo, request, new SendParameters());
                Assert.IsTrue(peerTwo.WaitForNextResponse(WaitTimeout));
                resp = peerTwo.GetResponseList();
                Assert.AreEqual(0, resp[0].ReturnCode, resp[0].DebugMessage);
        ...
        public void JoinCheckUserIds_Default_No_Check()
        {
            ...
            var peerTwo = new DummyPeer();
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne, "User1");
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo, "User1");
            ...
            finally
            {
                ...
                // get new room with same name
                var room = TestGameCache.Instance.GetRoomReference("testGame", HivePeerOne);
                var game = (TestGame)room.Room;
                room.Dispose();
                game.WaitForDispose();
            }
        ...
        public void JoinDisconnectRejoin()
        {
            ...
            var HivePeers = new TestHivePeer[PeersCount];

            for (var i = 0; i < PeersCount; ++i)
            {
                var peer = new DummyPeer();
                nativePeers[i] = peer;
                HivePeers[i] = new TestHivePeer(peer.Protocol, peer);
            }
            ...
            try
            {
                ...
                for (var i = 0; i < PeersCount; ++i)
                {
                    ...
                    PeerHelper.InvokeOnOperationRequest(HivePeers[i], request, new SendParameters());
                ...
                var leaveHivePeer = HivePeers[3];

                HivePeers[3] = null;
                nativePeers[3] = null;

                room = TestGameCache.Instance.GetRoomReference("testGame", leaveHivePeer);
                Assert.AreNotEqual(null, room);
                var game = (TestGame)room.Room;

                PeerHelper.SimulateDisconnect(leaveHivePeer);
        ...
        public void JoinDisconnectRejoinWithGroups()
        {
            ...
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne);
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo);
            var HivePeerThree = new TestHivePeer(peerThree.Protocol, peerThree);
            ...
            try
            {
                ...
                // join peers
                JoinPeer(peerOne, HivePeerOne, 1, parameter);

                JoinPeer(peerTwo, HivePeerTwo, 2);
                ReceiveJoinEvent(peerOne, 2);

                JoinPeer(peerThree, HivePeerThree, 3);
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerTwo, request, new SendParameters());
                PeerHelper.InvokeOnOperationRequest(HivePeerThree, request, new SendParameters());
                ...
                JoinPeer(peerTwo, HivePeerTwo, 2, parameter);
                ReceiveJoinEvent(peerOne, 2);
            ...
            finally
            {
                PeerHelper.SimulateDisconnect(HivePeerOne);
                PeerHelper.SimulateDisconnect(HivePeerTwo);
                PeerHelper.SimulateDisconnect(HivePeerThree);
            }
        }
        ...
        public void RaiseEventActors()
        {
            ...
            {
                // peer 1: join
                JoinPeer(peerOne, HivePeerOne, 1);
...
//            Thread.Sleep(1100);
        ...
        public void RaiseEventCacheRoom()
        {
            ...
            try
            {
                ...
                JoinPeer(peerOne, HivePeerOne, 1, customJoinparams);
        ...
        public void RaiseEventCacheRoomSlices()
        {
            ...
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo);
            var HivePeerThree = new TestHivePeer(peerThree.Protocol, peerThree);
            var HivePeerFour = new TestHivePeer(peerFour.Protocol, peerFour);
            ...
            try
            {
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerFour, request, new SendParameters());
                ...
                PeerHelper.SimulateDisconnect(HivePeerFour);
                Thread.Sleep(10);
                HivePeerFour = new TestHivePeer(peerFour.Protocol, peerFour);
        ...
        public void HandleWebRpcOpTest()
        {
            ...
            {
                HivePeerOne.WebRpcHandler = new WebRpcHandler(
        ...
        public void MasterClientEventTests()
        {
            ...
            try
            {
                ...
                CheckMasterClientEvent(HivePeers[1], nativePeers[0]);

                room = TestGameCache.Instance.GetRoomReference("testGame", HivePeers[0]);
                ...
                System.Threading.Thread.Sleep(50); // to get all events before check
                Assert.AreEqual(2, game.MasterClientId);
                CheckMasterClientEvent(HivePeers[1], nativePeers[1]);
        ...
        {
            var peerOne = new DummyPeer();
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne, "myuser1");
        ...
        private static void PluginTestRoomTestBody(int playerTTL = 0)
        {
            ...
            try
            {
                ...
                var roomRef = TestGameCache.Instance.GetRoomReference("testGame", HivePeerOne);
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerOne, raiseEventrequest, new SendParameters());
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeerOne, setPropertiesRequest, new SendParameters());
        ...
        public void PluginOnCreateForgotCallTest()
        {
            ...
            try
            {
                ...
                var roomRef = TestGameCache.Instance.GetRoomReference(gameName, HivePeerOne);
        ...
        public void BanLeaveingPlayerTest()
        {
            ...
            var HivePeerOne = new TestHivePeer(peerOne.Protocol, peerOne, Player1);
            var HivePeerThree = new TestHivePeer(peerThree.Protocol, peerThree, Player1);
            var HivePeer4 = new TestHivePeer(peer4.Protocol, peer4, Player1);
            var HivePeerTwo = new TestHivePeer(peerTwo.Protocol, peerTwo, Player2);
            ...
            try
            {
                ...
                JoinPeer(peerOne, HivePeerOne, 1, parameters);
                JoinPeer(peerTwo, HivePeerTwo, 2, parameters);
                ...
                PeerHelper.InvokeOnOperationRequest(HivePeer4, request, new SendParameters());
        ...
        /// </param>
        private static void JoinPeer(DummyPeer peer, HivePeer HivePeer, int expectedNumber, Dictionary<byte, object> customParameters = null)
        {
            var request = GetJoinRequest(customParameters);
            PeerHelper.InvokeOnOperationRequest(HivePeer, request, new SendParameters());
            Assert.IsTrue(peer.WaitForNextResponse(WaitTimeout));
