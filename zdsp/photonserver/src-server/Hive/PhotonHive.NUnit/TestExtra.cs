...
namespace Photon.Hive.Tests
{
    ...
    public class TestHivePeer : HivePeer
    {
        ...
        protected bool TryCreateRoom(string gameId, out Room room, out Caching.RoomReference roomReference, params object[] args)
        {
            return TestGameCache.Instance.TryCreateRoom(gameId, this, out room, out roomReference, args);
        }
