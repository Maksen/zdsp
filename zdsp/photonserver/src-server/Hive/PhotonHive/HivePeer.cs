...
//   The HivePeer dispatches incoming <see cref="OperationRequest" />s at <see cref="OnOperationRequest">OnOperationRequest</see>.
...
namespace Photon.Hive
{
    ...
    public class HivePeer : ClientPeer
    {
        ...
        public void RemovePeerFromCurrentRoom(int reason, string detail)
        {
            ...
            mPrevRoomName = this.RoomReference.Room.Name;
            this.ReleaseRoomReference();
        }

        protected virtual void CleanUpPlayer()
        {
            IsJoinedRoom = false;
        }
        ...
        {
            Room room;
            HiveGameCache.Instance.TryCreateRoom(gameId, this, out room, out roomReference, args);
            return room != null;
        }
