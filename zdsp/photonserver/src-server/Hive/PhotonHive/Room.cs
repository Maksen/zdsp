...
namespace Photon.Hive
{
    ...
    public class Room : IDisposable
    {
        ...
        public Room(string name, RoomCacheBase roomCache = null, IGameStateFactory gameStateFactory = null, int maxEmptyRoomTTL = 0, PoolFiber executionFiber = null)
        ...
        ///   in the room cache after all peers have left the room.
        /// </param>
        protected Room(string guid, PoolFiber executionFiber, RoomCacheBase roomCache, IGameStateFactory gameStateFactory = null, int maxEmptyRoomTTL = 0)
        {
            this.Guid = guid;
            ...
            EmptyRoomLiveTime = maxEmptyRoomTTL;
        }
        ...
        public int EmptyRoomLiveTime
        {
            ...
            set { this.roomState.EmptyRoomLiveTime = value; }
        }
        ...
        ///   The send Parameters.
        /// </param>
        public virtual void ExecuteOperation(HivePeer peer, OperationRequest operation, SendParameters sendParameters)
        {
        }
