    ...
    public class Monster : Actor
    {
        ...
        public void Init(MonsterSpawnerBase spawner, OverwriteStatsCallback callback = null, long liveDuration=0)
        {
            ...
            if (!overwriteStats)
            {
                ...
                CombatStats.SetField(FieldName.AgilityBase, mArchetype.agility);
                CombatStats.SetField(FieldName.DexterityBase, mArchetype.dexterity);
                CombatStats.SetField(FieldName.ConstitutionBase, mArchetype.constitution);
                CombatStats.SetField(FieldName.IntelligenceBase, mArchetype.intelligence);
                CombatStats.SetField(FieldName.AccuracyBase, mArchetype.accuracy);
