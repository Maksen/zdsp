...
{
    public class RealmControllerDungeon : RealmControllerBossSlowMotion
    {
        public DungeonJson mDungeonInfo;
        ...
        public RealmControllerDungeon(RealmControllerJson info, GameLogic instance)
            : base(info, instance)
        {
        ...
        public override void OnMissionCompleted(bool success, bool broadcast)
        {
            ...
            foreach (Player player in mPlayers.Values)
            {
                ...
                LogMissionComplete(player.Slot, mRealmInfo.id, (int)mDungeonInfo.difficulty, mRealmInfo.reqlvl, entryBefore, entryAfter, true, mDungeonStoryInfo.lootrewarditems, stars);
            }*/
        }
