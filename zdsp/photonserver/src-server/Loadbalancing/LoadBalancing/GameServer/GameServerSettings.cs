namespace Photon.LoadBalancing.GameServer
{
    ...
    public sealed class GameServerSettings : ApplicationSettingsBase
    {
        ...
        public string ClusterIPAddress
        {
            get
            {
                return ((string)(this["ClusterIPAddress"]));
            }
        }
        ...
        public int OutgoingClusterServerPeerPort
        {
            get
            {
                return ((int)(this["OutgoingClusterServerPeerPort"]));
            }
        }
