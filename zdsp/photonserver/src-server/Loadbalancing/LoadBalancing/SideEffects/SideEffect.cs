namespace Zealot.Server.SideEffects
{
    ...
    public static class SideEffectFactory
    {
        private static readonly Dictionary<EffectType, Type> EffectTypeToClass = new Dictionary<EffectType, Type>()
        {
            ...
            {EffectType.Damage_DamageBaseOnWeaponElement, typeof(DamageSE) },
            ...
            {EffectType.StatsAttack_IncEleNoneDamage_Debuff, typeof(StatsSE) },
            ...
            {EffectType.StatsAttack_VSEleNoneDamage_Debuff, typeof(StatsSE) },
