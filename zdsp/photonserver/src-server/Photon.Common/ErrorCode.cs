namespace Photon.Common
{
    public enum ErrorCode : short
    {
        ...
        WebHookCallFailed = 0x7FFF - 24,
        InvalidCookie = 0x7FFF - 25,
        UsernameInUse = 0x7FFF - 26,
        UsernameDoesNotExist = 0x7FFF - 27,
        UserOrPassFailed = 0x7FFF - 28,
        InvalidLoginType = 0x7FFF - 29,
        InvalidClientVer = 0x7FFF - 30,
        PasswordChangeFailed = 0x7FFF - 31,
        UIDShiftFailed = 0x7FFF - 32,
        UIDShiftAccExist = 0x7FFF - 33,
        ServerOffline = 0x7FFF - 34,
        DuplicateLogin = 0x7FFF - 35,
    }
}
