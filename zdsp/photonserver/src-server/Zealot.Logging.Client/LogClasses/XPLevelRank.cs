namespace Zealot.Logging.Client.LogClasses
{
    ...
    public class XpLevelRank : LogClass
    {
        // WARNING!
        ...
        public int goldDeducted { get; set; }

        public int crystalDeducted { get; set; }
        ...
        public override RequestInsertRecord GetRequestInsertRecord()
        {
            ...
            {
                changeType.GetTypeCode(),
                before.GetTypeCode(),
                after.GetTypeCode(),
                goldDeducted.GetTypeCode(),
                crystalDeducted.GetTypeCode()
            };
