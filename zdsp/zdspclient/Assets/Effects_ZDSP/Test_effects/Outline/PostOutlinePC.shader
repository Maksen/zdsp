...
Shader "Custom/Post OutlinePC"
{
    Properties
    {
        _MainTex("Main Texture",2D)="black"{}
        _SceneTex("Scene Texture",2D)="black"{}
		_Thickness("Number of outline iterations",int)=20
		_Blur("Number of blur iterations",int)=20 
		_Colour("Outline colour", Color) = (0,1,1,1)
    }
    SubShader 
    {
        Pass 
        ...
        Pass 
        {
            ...
            { 
                ...
                half4 outcolor=ColorIntensityInRadius* _Colour *2+(1-ColorIntensityInRadius)*tex2D(_SceneTex,float2(i.uvs.x,i.uvs.y));
                return outcolor;				
            }
