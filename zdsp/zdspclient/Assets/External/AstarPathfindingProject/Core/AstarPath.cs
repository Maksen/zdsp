...
#region InspectorDebug
	...
	public bool showNavGraphs = false; //true
	 ...
	 */
	public PathLog logPathResults = PathLog.None; //PathLog.Normal
...
#region MainThreads
	...
	public NNInfo GetNearest (Vector3 position, NNConstraint constraint) {
		return GetNearest(position,constraint,null, null);
	}
	...
	/** Returns the nearest node to a position using the specified NNConstraint.
	 ...
	 \see Pathfinding.NNConstraint
	 */
	public NNInfo GetNearest (Vector3 position, NNConstraint constraint, GraphNode hint, Vector3? preferredDir) {
