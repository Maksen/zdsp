...
#region Styles
	...
	public void OnEnable () {        
        ...
        //will add a default gridgraph to scene
        if (script.astarData.graphs.Length < 1) //at this point of time graphs shall not be null
        {
    ...
    public void AddDefaultGraph()
    {
        System.Type defaulttype = typeof(GridGraph);
        AddGraph(defaulttype);
        GridGraph gg = script.astarData.graphs[0] as GridGraph;
        ...
        gg.maxSlope = 45F;
        gg.maxClimb = 2F;
        gg.center = new Vector3(150, -10, 150);        
        gg.UpdateSizeFromWidthDepth();
        //default collision settings         
        gg.collision.mask = (1 << 30)| (1 << 26); //30 is nav_collision, 26 is hideable & nav_collision
        gg.collision.fromHeight = 40;
        gg.collision.heightMask = (1<<28); //28 is nav_walkable
