...
public class XffectEventCustom : Editor 
{
    ...
    //aiklong: add localplayershake checkbox
    protected SerializedProperty LocalPlayerShake;
	...
	void InitSerializedProperty()
	{
        ...
        LocalPlayerShake = serializedObject.FindProperty("LocalPlayerShake");
	...
	void DrawCameraShake()
	{
        ...
        XEditor.DrawToggle("localShake?", "", LocalPlayerShake);
