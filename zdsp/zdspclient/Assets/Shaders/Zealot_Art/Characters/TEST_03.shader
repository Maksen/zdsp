...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(_Mask_00_var.r*_FlowMask_01_var.r*_FlowMask_02_var.r*((-1*(1.0-max(0,dot((i.normalDir*7.0), viewDirection))))+(-3.0))));
