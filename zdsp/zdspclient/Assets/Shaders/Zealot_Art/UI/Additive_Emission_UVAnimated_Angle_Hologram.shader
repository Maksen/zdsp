...
/*SF_DATA;ver:1.37;sub:START;pass:START;ps:flbk:Mobile/Particles/Additive Culled,iptp:0,cusa:True,bamd:0,cgin:,lico:0,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:False,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:0,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:False,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:True,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:True,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:3138,x:33322,y:32768,varname:node_3138,prsc:2|emission-7899-OUT,custl-680-RGB;n:type:ShaderForge.SFN_Tex2d,id:1332,x:32289,y:32515,ptovrint:False,ptlb:EmissionTex,ptin:_EmissionTex,varname:_EmissionTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:8242,x:32289,y:32743,ptovrint:False,ptlb:EmissionColor,ptin:_EmissionColor,varname:_EmissionColor,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:1656,x:32937,y:32642,varname:node_1656,prsc:2|A-1332-RGB,B-6263-OUT;n:type:ShaderForge.SFN_Panner,id:3408,x:32053,y:32674,varname:node_3408,prsc:2,spu:0,spv:-0.2|UVIN-3234-UVOUT,DIST-8773-OUT;n:type:ShaderForge.SFN_TexCoord,id:9063,x:31283,y:32666,varname:node_9063,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Time,id:5723,x:31726,y:32699,varname:node_5723,prsc:2;n:type:ShaderForge.SFN_Slider,id:4069,x:31561,y:32854,ptovrint:False,ptlb:UVSpeed,ptin:_UVSpeed,varname:_UVSpeed,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-10,cur:1,max:10;n:type:ShaderForge.SFN_Multiply,id:8773,x:31896,y:32749,varname:node_8773,prsc:2|A-5723-T,B-4069-OUT;n:type:ShaderForge.SFN_Rotator,id:3234,x:31726,y:32563,varname:node_3234,prsc:2|UVIN-9063-UVOUT,ANG-9048-OUT;n:type:ShaderForge.SFN_Slider,id:6930,x:31175,y:32477,ptovrint:False,ptlb:Angle,ptin:_Angle,varname:_Angle,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:2;n:type:ShaderForge.SFN_Pi,id:8311,x:31365,y:32356,varname:node_8311,prsc:2;n:type:ShaderForge.SFN_Multiply,id:9048,x:31485,y:32415,varname:node_9048,prsc:2|A-8311-OUT,B-6930-OUT;n:type:ShaderForge.SFN_Tex2d,id:6712,x:32198,y:33421,ptovrint:False,ptlb:UVAnimatedTex,ptin:_UVAnimatedTex,varname:_UVAnimatedTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-3408-UVOUT;n:type:ShaderForge.SFN_Multiply,id:7899,x:32930,y:32982,varname:node_7899,prsc:2|A-1656-OUT,B-6712-RGB;n:type:ShaderForge.SFN_ValueProperty,id:1256,x:32466,y:33271,ptovrint:False,ptlb:FlashIntensity,ptin:_FlashIntensity,varname:_FlashIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;n:type:ShaderForge.SFN_Multiply,id:6263,x:32738,y:32700,varname:node_6263,prsc:2|A-8242-RGB,B-3009-OUT;n:type:ShaderForge.SFN_Add,id:3009,x:32665,y:32963,varname:node_3009,prsc:2|A-838-OUT,B-5065-OUT;n:type:ShaderForge.SFN_Vector1,id:838,x:32289,y:33249,varname:node_838,prsc:2,v1:1;n:type:ShaderForge.SFN_Multiply,id:5065,x:32652,y:33127,varname:node_5065,prsc:2|A-7522-OUT,B-1256-OUT;n:type:ShaderForge.SFN_Vector1,id:527,x:32289,y:33159,varname:node_527,prsc:2,v1:10;n:type:ShaderForge.SFN_Subtract,id:7522,x:32466,y:33100,varname:node_7522,prsc:2|A-527-OUT,B-838-OUT;n:type:ShaderForge.SFN_Color,id:680,x:33030,y:33239,ptovrint:False,ptlb:HologramColor,ptin:_HologramColor,varname:_EmissionColor_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:0.1292089,c3:0.2058824,c4:1;proporder:1332-8242-6712-4069-6930-1256-680;pass:END;sub:END;*/

Shader "AAA_UI/Additive_Emission_UVanimated_Angle_Hologram" {
    Properties {
        ...
        _HologramColor ("HologramColor", Color) = (0,0.1292089,0.2058824,1)
    }
    SubShader {
        Tags {
...
////// Emissive:
                ...
                float3 finalColor = emissive + _HologramColor.rgb;
