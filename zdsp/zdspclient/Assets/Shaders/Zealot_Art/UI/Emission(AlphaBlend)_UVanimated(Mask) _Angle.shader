...
/*SF_DATA;ver:1.26;sub:START;pass:START;ps:flbk:Mobile/Particles/Additive Culled,iptp:0,cusa:False,bamd:0,lico:0,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:False,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,rfrpo:False,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:True,fnfb:False;n:type:ShaderForge.SFN_Final,id:4013,x:32719,y:32712,varname:node_4013,prsc:2|emission-4130-OUT,alpha-1104-A;n:type:ShaderForge.SFN_Tex2d,id:1104,x:32054,y:32624,ptovrint:False,ptlb:EmissionTex(Alphablend),ptin:_EmissionTexAlphablend,varname:_EmissionTexAlphablend,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:2837,x:31739,y:33007,varname:node_5820,prsc:2,ntxv:0,isnm:False|UVIN-9699-UVOUT,TEX-567-TEX;n:type:ShaderForge.SFN_Multiply,id:1128,x:32306,y:32900,varname:node_1128,prsc:2|A-2837-RGB,B-8631-A;n:type:ShaderForge.SFN_Tex2dAsset,id:567,x:31458,y:33259,ptovrint:False,ptlb:UVAnimatedTex(Mask),ptin:_UVAnimatedTexMask,varname:_UVAnimatedTexMask,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:8631,x:31724,y:33412,varname:node_9273,prsc:2,ntxv:0,isnm:False|TEX-567-TEX;n:type:ShaderForge.SFN_Panner,id:9699,x:31413,y:33005,varname:node_9699,prsc:2,spu:0,spv:1|UVIN-2752-UVOUT,DIST-3502-OUT;n:type:ShaderForge.SFN_Time,id:648,x:31003,y:33186,varname:node_648,prsc:2;n:type:ShaderForge.SFN_Slider,id:5984,x:30838,y:33341,ptovrint:False,ptlb:UVSpeed,ptin:_UVSpeed,varname:_UVSpeed,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-3,cur:1,max:3;n:type:ShaderForge.SFN_Multiply,id:3502,x:31243,y:33227,varname:node_3502,prsc:2|A-648-T,B-5984-OUT;n:type:ShaderForge.SFN_TexCoord,id:3348,x:31002,y:32785,varname:node_3348,prsc:2,uv:0;n:type:ShaderForge.SFN_OneMinus,id:7058,x:32054,y:32814,varname:node_7058,prsc:2|IN-8631-A;n:type:ShaderForge.SFN_Multiply,id:1255,x:32306,y:32674,varname:node_1255,prsc:2|A-1104-RGB,B-7058-OUT;n:type:ShaderForge.SFN_Add,id:4130,x:32525,y:32798,varname:node_4130,prsc:2|A-1255-OUT,B-1128-OUT;n:type:ShaderForge.SFN_Rotator,id:2752,x:31202,y:32810,varname:node_2752,prsc:2|UVIN-3348-UVOUT,ANG-4398-OUT;n:type:ShaderForge.SFN_Slider,id:4398,x:30939,y:33002,ptovrint:False,ptlb:angle,ptin:_angle,varname:_angle,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:7;proporder:1104-567-5984-4398;pass:END;sub:END;*/

Shader "AAA_UI/Emission(AlphaBlend)_UVAnimated(Mask)_Angle" {
    Properties {
