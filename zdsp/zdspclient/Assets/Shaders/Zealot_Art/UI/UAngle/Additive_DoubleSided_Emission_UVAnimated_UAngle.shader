...
////// Emissive:
                ...
                float2 node_3408 = (node_3234+(node_5723.g*_UVSpeed)*float2(-0.2,0));
                float4 _UVAnimatedTex_var = tex2D(_UVAnimatedTex,TRANSFORM_TEX(node_3408, _UVAnimatedTex));
                float3 emissive = ((_EmissionTex_var.rgb*(i.vertexColor.rgb*(node_838+((10.0-node_838)*_FlashIntensity))))*_UVAnimatedTex_var.rgb);
