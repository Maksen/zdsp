...
{
    [AddComponentMenu("Spawners at Server/SMBossSpawner")]
    public class SMBossSpawner : ServerEntityWithEvent {
		...
		{
			SMBossSpawnerJson jsonclass = new SMBossSpawnerJson();
			GetJson(jsonclass);
			return jsonclass;
		}
		
		public void GetJson(SMBossSpawnerJson jsonclass)
		{
