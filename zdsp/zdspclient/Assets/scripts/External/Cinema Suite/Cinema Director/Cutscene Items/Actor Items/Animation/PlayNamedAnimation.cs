...
{
    [CutsceneItemAttribute("Animation", "Play Named Animation", CutsceneItemGenre.ActorItem)]
    public class PlayNamedAnimation : CinemaActorAction
    {
        ...
        public override void Trigger(GameObject Actor)
        {
            ...
            animationClip = animation.GetClip(animationName);
            if (!animationClip)
            {
                return;
            }
