...
{
    /// <summary>
    /// Enable the Effect Actor related to this event.
    /// </summary>
    [CutsceneItemAttribute("Effects", "Enable Xffect", CutsceneItemGenre.ActorItem)]
    public class EnableXffect : CinemaActorAction, IRevertable
    {
