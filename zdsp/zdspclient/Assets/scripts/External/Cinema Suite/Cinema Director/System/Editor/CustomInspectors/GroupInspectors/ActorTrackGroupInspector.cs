...
public class ActorTrackGroupInspector : Editor
{
    ...
    private SerializedProperty NPCArchetype;
    private SerializedProperty hasWeapon;
    ...
    private void OnEnable()
    {
        ...
        this.NPCArchetype = serializedObject.FindProperty("Archetype");
        this.hasWeapon = serializedObject.FindProperty("hasWeapon");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(actorGroup is NPCTrackGroup)
        {
            EditorGUILayout.PropertyField(NPCArchetype);
        }else if(actorGroup is PlayerTrackGroup)
        {
            EditorGUILayout.PropertyField(hasWeapon);
        }
        if (tracks.Length > 0)
        {
