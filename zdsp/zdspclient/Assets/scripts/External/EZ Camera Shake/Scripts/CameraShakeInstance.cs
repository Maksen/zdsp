...
namespace EZCameraShake
{
    ...
    public class CameraShakeInstance
    {
        ...
        /// <summary>
        /// How much time to elapse before starting the shake
        /// </summary>
        ...
        public CameraShakeInstance(float magnitude, float roughness, float fadeInTime, float fadeOutTime, float startTime = 0)
        {
        ...
        /// <param name="magnitude">The intensity of the shake.</param>
        /// <param name="roughness">Roughness of the shake. Lower values are smoother, higher values are more jarring.</param>
        public CameraShakeInstance(float magnitude, float roughness, float startTime = 0)
        {
            this.Magnitude = magnitude;
            this.Roughness = roughness;
            sustain = true;
        ...
        { get { return elapsedTime >= StartTime; } }
