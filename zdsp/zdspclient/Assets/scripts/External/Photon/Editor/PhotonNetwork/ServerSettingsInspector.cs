    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (settings.HostType)
        {
            ...
            case ServerSettings.HostingOption.SelfHosted:
                ...
                EditorGUILayout.LabelField("Servers Address", EditorStyles.centeredGreyMiniLabel);
                settings.ServerAddressPrivate = EditorGUILayout.TextField("Private Address: ", settings.ServerAddressPrivate);
                settings.ServerAddressPrivate = settings.ServerAddressPrivate.Trim();
                settings.ServerAddressStaging = EditorGUILayout.TextField("Staging Address: ", settings.ServerAddressStaging);
                settings.ServerAddressStaging = settings.ServerAddressStaging.Trim();
                settings.ServerAddressLive = EditorGUILayout.TextField("Live Address: ", settings.ServerAddressLive);
                settings.ServerAddressLive = settings.ServerAddressLive.Trim();
                settings.ServerAddressPublicTest = EditorGUILayout.TextField("Public Test Address: ", settings.ServerAddressPublicTest);
                settings.ServerAddressPublicTest = settings.ServerAddressPublicTest.Trim();

                EditorGUILayout.EndVertical();

                EditorGUILayout.LabelField("Server Type : " + settings.LoginServerType.ToString());
                EditorGUILayout.LabelField("Server Address : " + settings.ServerAddress);
