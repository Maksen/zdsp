...
public enum PhotonNetworkingMessage
{
    ...
    /// <summary> Called after connection with game server is establish. </summary>
	OnConnectedToGameServer,

    /// <summary> Called after client communicate with game server to authenticate cookie. </summary>
	OnAuthenticatedCookie,

    /// <summary> Called after establish connection is sucessful. </summary>
    OnEstablishedConnection,

    /// <summary> Called after recieving server list result. </summary>
	OnGetServerList,

    /// <summary> Called after receiving registration result. </summary>
	OnRegisterResult,

    /// <summary> Called after easy login or username login is successful. </summary>
    OnLoginSuccess,

    /// <summary> Called after easy login or username login has failed. </summary>
	OnLoginFailed,

    /// <summary> Called when version check with master server failed. </summary>
    InvalidClientVer,

    /// <summary> Called after google login is successful. </summary>
	OnGoogleLoginSuccess,

    /// <summary> Called after client communicate with game server to verify if login id is in use. </summary>
    OnVerifiedLoginId,

    OnConnectGameSetup,
    /// <summary> Get result of password change form server. </summary>
    //OnPasswordModifyResult,

    /// <summary> Get result of UID Shift. </summary>
    //OnUIDShiftResult,
