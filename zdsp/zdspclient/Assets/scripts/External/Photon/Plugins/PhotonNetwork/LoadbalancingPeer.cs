...
using ExitGames.Client.Photon;
    ...
    internal class LoadBalancingPeer : PhotonPeer
    {
        ...
        /// <summary>LoadBalancingPeer.OpAuthenticateCookie</summary>
        public virtual bool OpAuthenticateCookie(Dictionary<byte, object> opParameters)
        {
            return this.OpCustom(OperationCode.AuthenticateCookie, opParameters, true, (byte)0, this.IsEncryptionAvailable);
        }
        ...
        public virtual bool OpAuthenticate(string appId, string appVersion, AuthenticationValues authValues, string regionCode)
        {
            ...
            opParameters[ParameterCode.ClientPlatform] = GameVersion.GetClientPlatform();
    ...
    public class ErrorCode
    {
        ...
        /// <summary>
        /// (32753) Invalid cookie data, can be due to empty or null data. Check error message for details.
        /// </summary>
        public const int InvalidCookie = 0x7FFF - 25;
        public const int UsernameInUse = 0x7FFF - 26;
        public const int UsernameDoesNotExist = 0x7FFF - 27;
        public const int UserOrPassFailed = 0x7FFF - 28;
        public const int InvalidLoginType = 0x7FFF - 29;
        public const int InvalidClientVer = 0x7FFF - 30;
        public const int PasswordChangeFailed = 0x7FFF - 31;
        public const int UIDShiftFailed = 0x7FFF - 32;
        public const int UIDShiftAccExist = 0x7FFF - 33;
        public const int ServerOffline = 0x7FFF - 34;
        public const int DuplicateLogin = 0x7FFF - 35;
    }
    ...
    public class ParameterCode
    {
        ...
        #region Self Used Parameters
        public const byte Username = 99;
        public const byte Password = 98;
        public const byte LoginType = 97;
        public const byte LoginId = 96;
        public const byte DeviceId = 95;
        public const byte CookieId = 94;
        public const byte UniqueId = 93;
        public const byte Email = 92;
        public const byte ServerList = 91;
        public const byte ServerID = 90;
        public const byte VoiceChatAddress = 89;
        public const byte ClientPlatform = 88;
        #endregion
    }
    ...
    public class OperationCode
    {
        ...
        public const byte AuthenticateOnce = 247;

        /// <summary>(236) Bind current account to another account</summary>
        //public const byte UIDShift = 236;

        /// <summary>(235) Change password for official account</summary>
        //public const byte PasswordModify = 235;

        public const byte ConnectGameSetup = 235;

        /// <summary>(234) Verify if login ID already exist</summary>
        public const byte VerifyLoginId = 234;

        /// <summary>(233) Auhtenticate cookie against game server</summary>
        public const byte AuthenticateCookie = 233;

        /// <summary>(232) Get latest server list</summary>
        public const byte GetServerList = 232;

        /// <summary>(231) Register peer's login and password</summary>
		public const byte Register = 231;
        ...
        /// <summary>(224) Checkmail Operation.</summary>
        public const byte CheckMail = 224;
        ...
        /// <summary>(2) Ban player Operation.</summary>
        public const byte BanThisPlayer = 216;

        /// <summary>(1) Zealot custom Operation.</summary>
        public const byte Combat = 1;

        /// <summary>(2) Zealot Inventory Operation.</summary>
        //public const byte Inventory  = 2;

        /// <summary>(3) Zealot Quest Operation.</summary>
        //public const byte Quest  = 3;

        /// <summary>(4) Zealot Social Operation.</summary>
        //public const byte Social  = 4;

        /// <summary>(5) Zealot Guild Operation.</summary>
        //public const byte Guild  = 5;

        /// <summary>(6) Zealot Guild Operation.</summary>
        public const byte Action = 6;

        /// <summary>(7) Zealot Lobby Operation.</summary>
        public const byte Lobby = 7;

        /// <summary>(8) Zealot Lobby Operation.</summary>
        public const byte LocalObject = 8;

        /// <summary>(9) Zealot Unreliable Combat Operation.</summary>
        public const byte UnreliableCombat = 9;

        /// <summary>(9) Zealot Non Combat Operation.</summary>
        public const byte NonCombat = 10; //should include Quest, Social, Guild   
    }
...
public class AuthenticationValues
{
    ...
    private CustomAuthenticationType authType = CustomAuthenticationType.Custom;
    ...
    public virtual void AddAuthParameter(string user, string token)
    {
        this.AuthGetParameters = "username=" + System.Uri.EscapeDataString(user) + "&token=" + System.Uri.EscapeDataString(token);
    }

    public override string ToString()
    {
        return AuthGetParameters + " s: " + Token;
    }
}
