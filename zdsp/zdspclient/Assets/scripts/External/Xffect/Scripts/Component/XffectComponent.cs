...
namespace Xft
{
    ...
    public class XffectComponent : MonoBehaviour
    {
        ...
        public void FindMyCamera()
        {
            ...
            if (mainCam != null)
                mCamera = mainCam.GetComponent<Camera>();
            else
            {
        ...
        public Dictionary<string, GameObject> MeshRendereObj = new Dictionary<string, GameObject>();
        //note this function also modified MeshList.
        MeshFilter CreateMeshObj(Material mat, string layername)
        {
            ...
            if (MeshRendereObj.ContainsKey(layername))
                MeshRendereObj[layername] = obj;
            else
                MeshRendereObj.Add(layername, obj);
        ...
        {
            foreach(KeyValuePair<string, GameObject> rendereobj in MeshRendereObj)
            {
                rendereobj.Value.SetActive(true);
            }
        }
        ...
        public void Initialize()
        {
            ...
            foreach (Transform child in transform)
            {
                ...
                if (MergeSameMaterialMesh)
                {
                    ...
                    {
                        MeshFilter mf = CreateMeshObj(mat, el.name);
        ...
        public void OnDestroy()
        {
            ...
            {
                Destroy(MeshList[index].GetComponent<MeshFilter>().sharedMesh);
            }
        }
