...
namespace Xft
{
    ...
    public class XftSprite : RenderObject
    {
        ...
        public void Transform()
        {
            ...
            if(ActiveCameraTracker.ActiveCamera != null)
                t = ActiveCameraTracker.ActiveCamera.transform;
            ...
            else if (Type == STYPE.XYINHERIT)
            {
                if (Node.Owner.AlwaysSyncRotation)
                {
                //    MyTransform.rotation = Node.Owner.transform.rotation * MyTransform.rotation;
                    MyTransform.rotation = Node.Owner.transform.rotation;
                }
            }
