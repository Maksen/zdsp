...
public class RPCProxy : RealProxy
{
		...
		: base(target.GetType())
	{
        ...
        mDefMethods.Add("OnLocalObject");
        mDefMethods.Add("SetMainContext");
		mDefMethods.Add("BeginRPC");
		mDefMethods.Add("EndRPC");
        mDefMethods.Add("get_BytesReceivedThisFrame");
        mDefMethods.Add("get_BytesSentThisFrame");
        mDefMethods.Add("ResetProfilingCounters");
    }
	...
	public IMessage HandleMethodCall(IMethodCallMessage methodCall)
	{
		...
		try
		{
			...
			if (mDefMethods.Contains(methodCall.MethodName))
				...
				((RPCBase)target).ProxyMethod(methodCall.MethodName, methodCall.InArgs);
